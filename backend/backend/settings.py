...
SECRET_KEY = 'django-insecure-$p@mx(r0ep1ri$x#d+b5%0=wy^%o8-^%v9x(c&tgyiav#w-=dd'
...
JAZZMIN_SETTINGS = {
    "site_title": "Krishna",
    "site_header": "Krishna",
    "site_brand": " Chaurasiya ",
    # "site_icon": "images/favicon.ico",
    # "site_logo": "krishna.png",
    "welcome_sign": "Welcome To Chaurasiya's Admin Page..",
    "copyright": "Krishna",
